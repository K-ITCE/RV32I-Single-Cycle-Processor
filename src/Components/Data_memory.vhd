...
/*
The memory controller is a last minute concept I had to come up with we weren't taught anything about it in class.
It uses the 2-bt 'offset' input to perform the correct data movement operation, including any required sign extension.
	...
	lw - read 32-bit (4 locations) data from memory - address divided by 4
	lh - read 
*/
